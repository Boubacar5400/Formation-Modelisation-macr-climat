...
shocks;
  % TFP constante
  %var A; periods 1:240; values A_ss;
    var A; periods 1:240; values 1.1;
  % --- Baseline : aucune politique (mu = 0, tau_co2 = 0) ---
  % var mu;      periods 1:240; values 0;
  % var tau_co2; periods 1:240; values 0;

  % --- Politique modérée PRÉCOCE (exemple) ---
  % var mu;      periods 1:120 121:240; values 0.20 0;
  % var tau_co2; periods 1:240;        values 0.03;

  % --- Politique FORTE mais TARDIVE (exemple) ---
  % var mu;      periods 80:200 201:240; values 0.60 0;
  % var tau_co2; periods 1:240;         values 0.03;
end;
