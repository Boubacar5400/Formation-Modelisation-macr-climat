...
M_.block_structure_stat.block(2).variable = [ 9 5 8 13 7 2 3 6 4 1 10 11];
M_.block_structure_stat.variable_reordered = [ 12 9 5 8 13 7 2 3 6 4 1 10 11];
...
M_.block_structure_stat.block(2).g1_sparse_rowval = int32([1 10 2 3 9 10 3 5 4 5 5 6 8 9 11 6 7 3 7 8 1 8 2 9 2 6 10 11 12 4 12 ]);
M_.block_structure_stat.block(2).g1_sparse_colval = int32([1 1 2 2 2 2 3 3 4 4 5 5 5 5 5 6 6 7 7 7 8 8 9 9 10 10 10 11 11 12 12 ]);
M_.block_structure_stat.block(2).g1_sparse_colptr = int32([1 3 7 9 11 16 18 21 23 25 28 30 32 ]);
...
save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'damage_null_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
